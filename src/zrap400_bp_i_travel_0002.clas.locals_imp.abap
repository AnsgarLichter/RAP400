"local test classes
CLASS ltcl_readonly_methods DEFINITION DEFERRED FOR TESTING.
CLASS ltcl_writing_methods DEFINITION DEFERRED FOR TESTING.

" local handler class
CLASS lhc_Travel DEFINITION INHERITING FROM cl_abap_behavior_handler
  FRIENDS ltcl_readonly_methods ltcl_writing_methods.
...
********************************************************************************
  METHOD get_instance_features.
    "read entities
    READ ENTITIES OF ZRAP400_i_Travel_0002 IN LOCAL MODE
      ENTITY Travel
...
***********************************************************************************************
    ...
    SELECT MAX( travel_id ) FROM zrap400_trav0002 INTO @DATA(max_travel_id).
...
**********************************************************************
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF ZRAP400_i_Travel_0002 IN LOCAL MODE
      ENTITY Travel
