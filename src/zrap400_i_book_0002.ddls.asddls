...
@ObjectModel.sapObjectNodeType.name: 'ZRAP400_Booking_0002'
define view entity ZRAP400_I_Book_0002
  as select from ZRAP400_BOOK0002 as Booking
  association to parent ZRAP400_I_Travel_0002 as _Travel on $projection.TravelID = _Travel.TravelID
